...
class OllamaService {
    ...
    getConfig(): OllamaConfig {
        ...
        return savedConfig || { baseUrl: 'http://localhost:11434', modelName: 'llama3' }; // Default model
    }
    ...
    async generate(params: GenerateParams, onData?: (chunk: any) => void): Promise<GenerateResult> {
        ...
        try {
            ...
            console.log("DEBUG : [OllamaService] Final output from Ollama:", finalResponse);
            return finalResponse;
        } catch (e: any) {
            console.error("DEBUG : [OllamaService] Error during generation:", e);
